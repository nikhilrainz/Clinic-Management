...
/*************************************** MEDICINE ***************************************/
	...
	@RequestMapping(value = "/api/insertmedicine", 
	...
	// Disable Medicine
	@RequestMapping(value = "/api/disablemedicine/{medId}",
...
/*************************************** DOCTOR ***************************************/
	...
	public List<Admin> getDocById(@PathVariable("searchString") String searchString)
	{
	...
	// Insert Doctor
	@RequestMapping(value = "/api/saveDoctor", method = { RequestMethod.POST,RequestMethod.PUT })
	...
	//GET Doctor BY SID
	@RequestMapping(value = "/api/editDoctorDetail/{sId}", 
	...
	public List<Admin> getStaffById(@PathVariable("searchString") String searchString) 
	{
	...
	//get staff by id
	@RequestMapping(value = "/api/editStaffDetail/{sId}", 
			method = RequestMethod.GET,
			headers = "Accept=application/json")
